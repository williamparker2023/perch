import { ArrowLeft, Image as ImageIcon, MapPin, AlignLeft, Unlock, Lock } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-2">
        ...
        <div className="flex items-center gap-4 py-4 cursor-pointer group border-b border-gray-100">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-900">Add Banner Photo</p>
            <p className="text-xs text-gray-400 mt-0.5">Optional cover image</p>
          </div>
        </div>

        {/* Form Fields */}
        <div className="space-y-0 divide-y divide-gray-100">
          <InputField icon={<AlignLeft size={22} strokeWidth={1.5} />} placeholder="Name of board (e.g., Summer in Paris)" />
          <InputField icon={<MapPin size={22} strokeWidth={1.5} />} placeholder="City or Region" />
        </div>
